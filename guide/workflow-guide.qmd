...
```bash
./scripts/backtest.sh          # all eight gates green on a clean tree
...
|---|---|---|---|---|---|
| Backtest (8 gates) | scripts, pre-commit + CI | repo-wide consistency/currency | **closed** — commit blocked | `--no-verify` | gate output, CI log |
