...
|---|---|---|
| `reduced-form` | identification credibility, robustness range | IV first-stage, overlap, balance |
...
- **Then attack the identifying assumption** with a named, computable statistic — E-value,
  Cinelli–Hazlett RV, Oster δ, Rosenbaum Γ.
...
| `/challenge` | `.claude/skills/challenge/` | Stress-test a finding against the choices you didn't make — specification curve over the discrete forks, then named sensitivity statistics (E-value, Cinelli–Hazlett RV, Oster δ, Rosenbaum Γ) against the identifying assumption |
